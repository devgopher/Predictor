...
Write-Host "Deploying Predictor chat/conclusions agent '$Agent' from appsettings.json"
...
New-OllamaAgent `
    ...
    -NumCtx $item.NumCtx
Test-OllamaChat -BaseUrl $item.BaseUrl -Model $agentName

Write-Host "Chat agent is ready."
